import { ILocaleData } from './en'

export const ptBr: ILocaleData = {
  language: 'pt-br',
  home_link: 'Início',
  about_link: 'Sobre',
  ...
  go_back_404: 'Voltar ao início',

  about_title: 'Sobre',
  about_hello: 'Olá, meu nome é Eduardo.',
  about_paragraph:
    'Sou Desenvolvedor Front-end [time_phrase] anos de experiência profissional, especialista em React.js, NextJS, React Native, HTML e CSS e capaz de transformar Designs em código claro, eficiente e organizado utilizando Javascript / Typescript.',
  about_paragraph_2:
