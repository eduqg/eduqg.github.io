export const en = {
  ...
  about_paragraph:
    "I'm a Front-end Developer [time_phrase] years of professional experience, specializing in React.js, NextJS, React Native, HTML, and CSS. Also, I'm capable of transforming Designs into clear, efficient, and organized code using Javascript/Typescript.",
  about_paragraph_2:
